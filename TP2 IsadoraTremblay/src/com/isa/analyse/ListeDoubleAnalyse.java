...
public class ListeDoubleAnalyse {
	public static void main(String[] args) {
		ListeDouble listeSimple1000 = new ListeDouble();
		ListeDouble listeSimple10000 = new ListeDouble();
		ListeDouble listeSimple100000 = new ListeDouble();
		...
		System.out.printf(
				"Suppression d'elements d'elements au debut 1000\nTemps total: %d\nTemps moyen: %d\nMinimum: %d\nMaximum: %d\n\n",
				time.getTotalTime(), time.getAverageTime(), time.getMinTime(), time.getMaxTime());
		time.start();
		...
		System.out.printf(
				"Suppression d'elements d'elements au debut 10 000\nTemps total: %d\nTemps moyen: %d\nMinimum: %d\nMaximum: %d\n\n",
				time.getTotalTime(), time.getAverageTime(), time.getMinTime(), time.getMaxTime());
		time.start();
		...
		System.out.printf(
				"Suppression d'elements d'elements au debut100 000\nTemps total: %d\nTemps moyen: %d\nMinimum: %d\nMaximum: %d\n\n",
				time.getTotalTime(), time.getAverageTime(), time.getMinTime(), time.getMaxTime());
	}
